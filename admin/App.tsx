...
import MasterDomainPage from './components/MasterDomainPage';
import SafeSitePage from './components/SafeSitePage';
import MultiMasterPage from './components/MultiMasterPage';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // 1. Hide the static loading screen now that React has mounted
